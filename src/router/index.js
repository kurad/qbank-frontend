...
const routes = [
  ...
  // --------------- Student Routes ----------------
  {
    ...
    children: [
      ...
      {
        path: "assessment-session/:id", // ✅ /practice/assessment-session/:id
        name: "AssessmentSession",
        component: () => import("@/views/student/AssessmentSession.vue"),
      },
      {
  ...
  // --------------- Teacher Routes ----------------
  {
    ...
    children: [
...

      {
        ...
        component: () =>
          import("@/components/assessment/AssessmentBuilder.vue"),
      },
      {
