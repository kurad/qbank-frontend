    ...
    <div class="flex-grow-1 d-flex" style="background:#f8f9fa;">
      <aside class="bg-white border-end shadow-sm d-flex flex-column" style="width: 220px; min-height:100%;">
        <ul class="nav flex-column py-4 px-3 gap-2">
          <li class="nav-item">
            <a href="#" class="nav-link active fw-semibold rounded-pill px-3 py-2">Dashboard</a>
          </li>
          <li class="nav-item">
            <router-link to="/questions" class="nav-link fw-semibold rounded-pill px-3 py-2">Create Question</router-link>
          </li>
          <li class="nav-item">
            <router-link to="/create-assessment" class="nav-link fw-semibold rounded-pill px-3 py-2">Create Assessment</router-link>
          </li>
          <li class="nav-item">
            <router-link to="/assign-assessment" class="nav-link fw-semibold rounded-pill px-3 py-2">Quizzes</router-link>
          </li>
          <li class="nav-item">
            <router-link to="/assessment-list" class="nav-link fw-semibold rounded-pill px-3 py-2">Assessments</router-link>
          </li>
          <li class="nav-item">
            <a href="#" class="nav-link fw-semibold rounded-pill px-3 py-2" data-bs-toggle="collapse" data-bs-target="#settingsSubMenu" aria-expanded="false" aria-controls="settingsSubMenu">Settings <i class="bi bi-chevron-down ms-1"></i></a>
            <ul class="collapse list-unstyled ps-4" id="settingsSubMenu">
              <li>
                <router-link :to="{ name: 'SubjectsManagement' }" class="nav-link fw-normal px-2 py-1">Subjects</router-link>
              </li>
              <li>
